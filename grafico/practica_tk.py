...
etiqueta.grid(row=0, column=0, padx=20, pady=10)

entrada_texto = ttk.Entry(root, font="Helvetica 20")
entrada_texto.grid(row=0, column=1, padx=10, pady=20)

etiqueta2 = ttk.Label(root, font="Helvetica 30",background="#0099cc",foreground="#f2f2f2")
etiqueta2.grid(row=1, column=0, columnspan=2)

boton = ttk.Button(root, text="Esto es un boton", command = saludar, padding=10)
...
root.mainloop() # Mantener activa laventana y escuchando eventos
