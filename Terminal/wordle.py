import random
palabras = ("anime", "bruto", "gordo", "abeja", "tinta", "aroma", 
            "tapon", "vetar", "acero", "cable", "reloj", "haber",
            "arbol", "trepo", "casos", "venta", "renta", "durar")
...
while True:
    ...
    print("""\033[1;32;44m
    ============================[★WORDLE★]=========================
    Bienvenido, ya he elegido la palabra secreta, tienes 5 intentos
    ================================================================\033[0;30;47m""")
